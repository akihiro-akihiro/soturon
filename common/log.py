...
class LogConst(Const):
    ...
    # ファイル検索用正規表現
    RE_SEARCH_ON_YEAR = "\.[0-9]{4}"
    RE_SEARCH_ON_MONTH = "\.[0-9]{4}-(0[1-9]|1[0-2])"
    RE_SEARCH_ON_DATE = "\.[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])"
    RE_SEARCH_ON_HOUR = "\.[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])_([01][0-9]|2[0-3])"
    RE_SEARCH_ON_MINUTE = "\.[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])_([01][0-9]|2[0-3])-[0-5][0-9]"
    RE_SEARCH_ON_SECOND = "\.[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])_([01][0-9]|2[0-3])-[0-5][0-9]-[0-5][0-9]"
    RE_SEARCH_ON_NUMBER = "\.[0-9]+"
